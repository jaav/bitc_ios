...
-(void)setDetailContent {
    ...
    int theprice = lroundf([self.myitem.price floatValue]);
    
    self.poiPrice.text = [NSString stringWithFormat:@"%@ %@%@", NSLocalizedString(@"PRICEFROM", nil), [NSString stringWithFormat:@"%i",theprice], NSLocalizedString(@"EACHNIGHT", nil)];
